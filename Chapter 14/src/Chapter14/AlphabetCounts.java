...
public class AlphabetCounts extends JFrame {
    ...
    public AlphabetCounts() {
        super("14.12 Alphabet Occurrences");
        ...
        b.addActionListener(e -> {
            int[] c = new int[26]; for (char x: in.getText().toLowerCase().toCharArray()) if (x >= 'a' && x <= 'z') c[x - 'a'] ++ ; out.setText("Letter\tCount\n"); for (int i = 0; i < 26; i ++ ) out.append((char)('a' + i) + "\t" + c[i] + "\n");
        });
    ...
    public static void main(String[] z) {
        new AlphabetCounts().setVisible(true);
    }
}
